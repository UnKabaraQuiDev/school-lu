document.addEventListener("DOMContentLoaded", async function () {
    ...
    const allowExamCreation =
        document.getElementById("allow-exam-creation");
    ...
    form.addEventListener("submit", async (event) => {
        ...
        try {
            const response = await fetch(apiUrl("exam-db/exercises/update-index"), {
                method: "POST",
                headers: {
